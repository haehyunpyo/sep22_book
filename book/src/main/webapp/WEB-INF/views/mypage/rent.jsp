			...
			<div class="menu" style="text-align: center;">
				...
				<c:forEach items="${list }" var="row">
					<div class="row" style="margin-bottom: 5px;">
						...
						<span class="menu-price font-alt col-sm-2 <c:if test="${row.rddate lt formattedDate && row.rdel eq 1}"></c:if>">
								...
								<c:when test="${row.rdel eq 1}">
									<script>
					                    ...
					                    if (rddate < today) {
					                        ...
					                        document.write('<span class="widget-posts-title font-alt" style="color: red;">대출중 (연체)</span>');
					                    } else {
					                        document.write('<span class="widget-posts-title font-alt">대출중</span>');
					                    }
									</script>
